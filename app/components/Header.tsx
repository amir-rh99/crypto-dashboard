...
const Header = () => {
    ...
    return (
        <nav className="container mx-auto px-2 py-3 lg:py-5 flex items-center justify-between">
            ...
            onClick={handleSidebar}>
                ...
                } bg-body fixed top-0 border-r border-info/40 bottom-0 w-52 z-30 transition-all`}>
                    <Sidebar />
                </div>
            </div>
