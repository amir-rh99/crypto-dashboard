                ...
                <div className="grid grid-cols-3 gap-10">
                  ...
                  <div className="col-span-2 flex flex-col gap-2">
                    ...
                    <div className="flex justify-between">
                      <div className="flex gap-2">
                        <span>
                          <svg className="w-6" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 32 32"><g fill="none" fill-rule="evenodd"><circle cx="16" cy="16" r="16" fill="#B06DDE"/><g fill="#FFF" fill-rule="nonzero"><path fill-opacity=".602" d="M16.498 4v8.87l7.497 3.35z"/><path d="M16.498 4L9 16.22l7.498-3.35z"/><path fill-opacity=".602" d="M16.498 21.968v6.027L24 17.616z"/><path d="M16.498 27.995v-6.028L9 17.616z"/><path fill-opacity=".2" d="M16.498 20.573l7.497-4.353-7.497-3.348z"/><path fill-opacity=".602" d="M9 16.22l7.498 4.353v-7.701z"/></g></g></svg>
                        </span>
                        <div className="flex flex-col">
                          <span className="text-title text-sm font-medium">
                            Ethereum
